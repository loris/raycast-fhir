...
export async function pinPackage(packageData: Omit<PinnedPackage, "pinnedDate" | "order">): Promise<void> {
...
export async function pinResource(resourceData: Omit<PinnedResource, "pinnedDate" | "order">): Promise<void> {
